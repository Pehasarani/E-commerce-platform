            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                        ...
                        <p><strong>Total Amount:</strong>$<?php echo number_format($order_details['amount'], 2); ?></p>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="text-right">
                                            <div class="text-gray-600">
                                                <span class="font-semibold">Price:</span>$<?php echo number_format($item['price'], 2); ?>
                                            </div>
                    ...
                    <div class="mt-6 bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between font-bold text-lg pt-2 border-t">
                                <span>Total</span>
                                <span class="text-primary">$<?php echo number_format($order_details['amount'], 2); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php else: ?>
